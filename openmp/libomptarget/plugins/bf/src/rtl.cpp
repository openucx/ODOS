...
#define   SEMA_NAME "omp_test_sema0"
...
int32_t __tgt_rtl_data_delete(int32_t ID, void *TargetPtr, int32_t Kind)
{
	...
	DOCA_LOG_INFO("data alloc: 0x%09x (%ld)\n", (size_t)TargetPtr, (size_t)TargetPtr);
...
int32_t __tgt_rtl_launch_kernel(int32_t ID, void *Entry,
